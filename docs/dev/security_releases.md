...
To that end, you'll need to be sure that security vulnerabilities are fixed in the [Security Repo](https://gitlab.com/gitlab-org/editor-extensions/security/gitlab-eclipse-plugin).

This is fundamental to our security release process because the [Security Repo](https://gitlab.com/gitlab-org/editor-extensions/security/gitlab-eclipse-plugin) is not publicly-accessible.
...
Once a security issue is assigned to a developer, we follow the same merge request and code review process as any other change, but on the [Security Repo](https://gitlab.com/gitlab-org/editor-extensions/security/gitlab-eclipse-plugin).
...
```shell
git remote add security git@gitlab.com:gitlab-org/editor-extensions/security/gitlab-eclipse-plugin.git
```
...
We release off the main branch. The release can be made from the [Security Repo](https://gitlab.com/gitlab-org/editor-extensions/security/gitlab-eclipse-plugin). See [release process docs](./release_process.md)
...
1. Create an MR to merge `security-9999` to the main branch of the [Security Repo](https://gitlab.com/gitlab-org/editor-extensions/security/gitlab-eclipse-plugin) and get it reviewed.
...
1. Create an MR from the security project:
   - **Source project:** `gitlab-org/editor-extensions/security/gitlab-eclipse-plugin`
   - **Source branch:** `main`
