...
@Suppress("unused")
class IssueSearchHandler(
  private val picker: WorkspaceProjectPicker = WorkspaceProjectPicker(),
  private val browser: BrowserLauncher = BrowserLauncher(),
) : AbstractHandler() {
  private val logger = logger<IssueSearchHandler>()

  private val noteableType = "issues"
  private val pathSegment = "issues"
  ...
  override fun execute(event: ExecutionEvent): Any? {
    ...
    logger.info("issueSearch requested.")
    return null
  }
