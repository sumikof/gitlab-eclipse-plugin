...
class CodeSuggestionsEnabledLanguageServiceTest : DescribeSpec({
  val preferenceStore = mockk<ScopedPreferenceStore>()

  val codeSuggestionsEnabledLanguageService = CodeSuggestionsEnabledLanguageService(preferenceStore)
  ...
  describe("getAdditionalLanguages") {
    it("returns empty list when preference is blank") {
      ...
      val result = codeSuggestionsEnabledLanguageService.getAdditionalLanguages()
